...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(473, 695)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(473, 695))
        MainWindow.setMaximumSize(QtCore.QSize(473, 695))
        MainWindow.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.lblImage = QtGui.QLabel(self.centralwidget)
        self.lblImage.setGeometry(QtCore.QRect(35, 42, 401, 111))
        ...
        self.btnLoad.setGeometry(QtCore.QRect(30, 180, 411, 23))
        self.btnLoad.setObjectName(_fromUtf8("btnLoad"))
        self.btnDelete = QtGui.QPushButton(self.centralwidget)
        self.btnDelete.setGeometry(QtCore.QRect(30, 650, 411, 23))
        self.btnDelete.setObjectName(_fromUtf8("btnDelete"))
        self.listWidget = QtGui.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(30, 220, 411, 411))
